...
public class KataTest {
    ...
    public void test() {
        ...
        assertEquals(-1, Kata.findEvenIndex(new int[] {8, 8}));
        assertEquals(0, Kata.findEvenIndex(new int[] {8, 0}));
        assertEquals(1, Kata.findEvenIndex(new int[] {0, 8}));
        assertEquals(0, Kata.findEvenIndex(new int[] {7, 3, -3}));
        assertEquals(0, Kata.findEvenIndex(new int[] {8}));
    ...
    public void test1() {
        ...
        for (int i = 0; i < 100; i++) { 
            ...
            assertEquals(findEvenIndexSol(a3), Kata.findEvenIndex(a3));
        }
    }
}
